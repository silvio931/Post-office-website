...
$veza = new Baza();
$veza->spojiDB();
$upit = "SELECT uloga_id as id, naziv as naziv FROM uloga order by 1";
...
$xmlDom->appendChild($xmlDom->createElement('uloge'));
$xmlRootNode = $xmlDom->documentElement;

if ($num_rows === 0) {
    $xmlRowElementNode = $xmlDom->createElement('uloga');
