...
$veza = new Baza();
$veza->spojiDB();
$upit = "SELECT vrsta_statusa_id as id, naziv as naziv FROM vrsta_statusa order by 1";
...
$xmlDom->appendChild($xmlDom->createElement('statusi'));
$xmlRootNode = $xmlDom->documentElement;

if ($num_rows === 0) {
    $xmlRowElementNode = $xmlDom->createElement('status');
